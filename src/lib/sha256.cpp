...
inline void processChunk(uchar *chunk, uint32 *w, uint32 *h) {
    uint32 k[] = {
...
namespace sha2 {
    ...
    string sha256(string filePath) {
        return validateFileForHashFunction(filePath, MAX_MESSAGE_SIZE, sha256FromStream);
    }
